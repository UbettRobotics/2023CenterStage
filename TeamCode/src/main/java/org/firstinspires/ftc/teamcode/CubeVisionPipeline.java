...
public class CubeVisionPipeline extends OpenCvPipeline {
    Telemetry telemetry;
    ...
    public CubeVisionPipeline(Telemetry t, int isRed, int isPark) { telemetry = t; fieldColor = isRed; park = isPark; }
